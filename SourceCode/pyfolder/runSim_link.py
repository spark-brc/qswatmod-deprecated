...
def create_swatmf_link(
    ...
    with open(infile, 'r') as f:
        ...
        if self.dlg.radioButton_gw_delay_multi.isChecked():
            ...
            input1 = QgsMapLayerRegistry.instance().mapLayersByName("gw_delay")[0]
            data = [i.attributes() for i in input1.getFeatures()]
            hru_idx = input1.dataProvider().fields().fieldNameIndex("HRU_ID")
    ...
    msgBox = QMessageBox()
    msgBox.setWindowIcon(QIcon(':/newPrefix/pics/logo.png'))
