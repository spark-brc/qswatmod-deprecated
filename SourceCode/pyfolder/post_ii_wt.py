...
def read_grid_id(self):
    for self.layer in QgsMapLayerRegistry.instance().mapLayers().values():
            ...
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                if (len(df3[wt_ob]) > 1):
                    ...
                    with open(
                        ...
                        f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                                +")_d_dtw.txt is created by QSWATMOD plugin "+ version + time + "\n")
                ...
                if (len(df3[wt_ob]) > 1):
                    ...
                    with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")"+
                        ...
                        f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                                +")_d_wt.txt is created by QSWATMOD plugin "+ version + time + "\n")
                        df3.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                        f.write('\n')
                        f.write("# Statistics\n")
                        f.write("Nash–Sutcliffe: " + str('{:.4f}'.format(dNS) + "\n"))
        ...
        try:
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_d_dtw.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_d_dtw.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_d_wt.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_d_wt.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                    df.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
        ...
        try:
            ...
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")"+
                    ...
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                            +")_m_dtw.txt is created by QSWATMOD plugin "+ version + time + "\n")
                    df3.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
                    f.write("Nash–Sutcliffe: " + str('{:.4f}'.format(dNS) + "\n"))
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")"+
                    ...
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                            +")_m_wt.txt is created by QSWATMOD plugin "+ version + time + "\n")
                    df3.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
                    f.write("Nash–Sutcliffe: " + str('{:.4f}'.format(dNS) + "\n"))
        ...
        try:
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_m_dtw.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_m_dtw.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_m_wt.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_m_wt.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                    dfm.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
        ...
        try:
            ...
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")"+
                    ...
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                            +")_a_dtw.txt is created by QSWATMOD plugin "+ version + time + "\n")
                    df3.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
                    f.write("Nash–Sutcliffe: " + str('{:.4f}'.format(dNS) + "\n"))
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")"+
                    ...
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")"+"_ob("+ str(wt_ob)
                            +")_a_wt.txt is created by QSWATMOD plugin "+ version + time + "\n")
                    df3.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
                    f.write("Nash–Sutcliffe: " + str('{:.4f}'.format(dNS) + "\n"))
        ...
        try:
            if self.dlg.checkBox_depthTowater.isChecked():
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_a_dtw.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_a_dtw.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                ...
                with open(os.path.join(outfolder, "swatmf_grid_id(" + str(grid_id) + ")_a_wt.txt"), 'w') as f:
                    f.write("# swatmf_grid_id(" + str(grid_id) + ")_a_wt.txt is created by QSWATMOD plugin "
                        + version + time + "\n")
                    dfa.to_csv(f, index_label = "Date", sep = '\t', float_format='%10.4f', line_terminator='\n', encoding='utf-8')
                    f.write('\n')
                    f.write("# Statistics\n")
